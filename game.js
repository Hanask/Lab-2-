...
function getRandomInt(max){  //generates a random number from 0 to max 
...
function addBee()  {
    let val=Number(document.getElementById("nbBees").value);
    let num=val+1;
    document.getElementById("nbBees").value = num;
    var bee = new Bee(num);
    bee.display();
    bees.push(bee);
}
